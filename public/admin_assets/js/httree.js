...
function customMenu(node) {
    ...
    var items = {
        renameItem: {// The "rename" menu item
            ...
            action: function () {
                document.location = '/admin/pages/addnode/' + node.li_attr.nodeid;
            }
        },
...
function updateNodePos(pos, nodeid, parentid)
{
    ...
    $.post('/admin/pages/movenode/' + nodeid, {data: datas},
    function (data) {
        if (data.sux === 0)
        {
...
function setButtons(id)
{
    ...
    str += '<a class="btn btn-sm btn-icon btn-primary mt-3 mb-3" href="/admin/pages/addnode/'+id+'" title="Добавить подраздел"><i class="fa fa-plus"></i></a>';
    str += '<a class="btn btn-sm btn-icon btn-primary mt-3 mb-3" href="/admin/pages/editnode/'+id+'" title="Редактировать"><i class="ki-outline ki-pencil fs-5 m-0"></i></a>';
    str += '<a class="btn btn-sm btn-icon btn-danger mt-3 mb-3 htdell" href="#" data-id="'+id+'" title="Удалить"><i class="ki-outline ki-trash fs-5 m-0"></i></a>';
    str += '</div>';
