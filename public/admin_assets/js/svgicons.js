...
;( function( window ) {
	...
	function svgIcon( el, config, options ) {
		...
		// reverse?
		if( hasClass( this.el, 'si-icon-reverse' ) || ($.cookie && $.cookie('sidebar_closed') === '1') ) {
			this.reverse = true;
		}
...
$(document).ready(function () {
    ...
    new svgIcon( document.querySelector( '.si-icon-hamburger' ), svgIconConfig, { size : {h:30, w:30}} );
    new svgIcon( document.querySelector( '.si-icon-hamburger-resp' ), svgIconConfig, { size : {h:30, w:30}} );
});