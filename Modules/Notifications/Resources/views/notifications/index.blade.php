		...
		<div class="card card-flush h-lg-100">
			...
			<div class="card-header pt-5">
				...
				<h3 class="card-title align-items-start flex-column">
					<span class="card-label fw-bold text-dark">Notify activity{{ request()->get('stat') == 'minute' || !request()->get('stat') ? ' / Minute' : '' }}{{ request()->get('stat') == 'hour' ? ' / Hour' : '' }}{{ request()->get('stat') == 'day' ? ' / Day' : '' }}{{ request()->get('stat') == 'week' ? ' / Week' : '' }}</span>
