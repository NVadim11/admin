...
@section('content')
		...
		<div class="card card-flush h-lg-100">
			...
			<div class="card-header pt-5">
				...
				<h3 class="card-title align-items-start flex-column">
					<span class="card-label fw-bold text-dark">Daily Quest Progress</span>
			...
			<div class="card-body pt-0 px-0">
				...
				<div class="d-flex align-items-center px-9">
					...
					<div class="d-flex align-items-center">
						...
						<!--end::Bullet-->
						<!--begin::Label-->
						<span class="fw-semibold fs-6 text-gray-600">Not completed</span>
						<!--end::Label-->
					</div>
					<!--ed::Item-->
				</div>
	...
	@php
        ...
        $incomplete = collect(array_reverse($gaming))->pluck('incomplete')->toJson();
        $maxCompleted= max(collect(array_reverse($gaming))->pluck('completed')->toArray());
        $maxIncomplete= max(collect(array_reverse($gaming))->pluck('incomplete')->toArray());
							...
							var a = t.hasAttribute("data-kt-negative-color") ? t.getAttribute("data-kt-negative-color") : KTUtil.getCssVariableValue("--bs-success"),
								...
								i = {
									series: [
										...
										{ name: "Not completed", data: {{ $incomplete }} },
									],
									...
									yaxis: {
										min: 0,
										max: {{ ($maxCompleted + $maxIncomplete) }},
										tickAmount: 6,
										labels: {
