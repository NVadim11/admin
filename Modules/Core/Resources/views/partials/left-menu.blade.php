    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            @foreach($modules as $section_name => $section)
                @php
                    $current = \Modules\Core\Entities\Modules::where('name', request()->segment(2))->first();
                @endphp
                <li class="active {{ isset($current) && $current->section == $section_name ? 'open' : ''}}">
                    <a href="javascript:;">
                    ...
                    <ul class="sub-menu" style="{{ !isset($current) || $current->section != $section_name ? 'display:none;' : ''}}">
