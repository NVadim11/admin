...
<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-850px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{ action($controller.'@modalCreate') }}" id="kt_modal_add_customer_form" data-kt-redirect="../../demo42/dist/apps/customers/list.html">
                <input type="hidden" name="images_table" value="{{ $images_table }}">
                <input type="hidden" name="table_link" value="{{ $table_link }}">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="fv-row mb-2">
                                    ...
                                    <div class="dropzone" id="kt_ecommerce_add_product_media">
                                        ...
                                        <div class="dz-message needsclick">
                                            ...
                                            <!--begin::Info-->
                                            <div class="ms-4">
                                                <h3 class="fs-5 fw-bold text-gray-900 mb-1">{{ __('core::app.title_media_drop') }}</h3>
                                                <span class="fs-7 fw-semibold text-gray-400">{{ __('core::app.title_media_gallery_format') }}</span>
                                            </div>
                                            <!--end::Info-->
                                        </div>
                                    </div>
                                ...
                                <!--end::Input group-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">{{ __('core::app.title_media_gallery') }}</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Card header-->
                        </div>
...
@push('scripts')
    <script src="{{ config('assets.base.scripts', '') }}/form/modal/images.js"></script>
    <script>
        "use strict";
