...
@section('page-title', 'Редактирование модуля')

@section('content')
    @section('actions')
        <a href="{{ route('modules.index') }}" class="btn btn-flex btn-outline btn-color-gray-700 btn-active-color-primary bg-body h-40px fs-7 fw-bold">К списку</a>
        <a href="{{ route('modules.create') }}" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">Добавить</a>
    @endsection
