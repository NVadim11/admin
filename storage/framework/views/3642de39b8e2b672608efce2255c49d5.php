...
<table class="table align-middle table-row-dashed gy-0" id="kt_customers_table">
	<thead>
		<tr class="text-start text-gray-400 text-nowrap fw-bold fs-8 text-uppercase gs-0">
			...
			<th class="min-w-30px mw-sm-30px align-middle"><?php echo e(__('ID')); ?></th>
			<?php if($sortable): ?>
				<th class="min-w-70px mw-sm-70px align-middle"><?php echo e(__('core::app.th_pos')); ?></th>
			<?php endif; ?>
			<?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<th class="min-w-125px align-middle"><?php echo e($field['name']); ?></th>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			<th class="text-end min-w-45px mw-sm-40px align-middle"><?php echo e(__('core::app.th_actions')); ?></th>
		</tr>
	</thead>
</table>
<!--end::Table-->
...
<?php $__env->startPush('scripts'); ?>
		...
		var KTItemsList = function () {
			...
			var initItemList = function () {
				...
				datatable = $(table).DataTable({
					...
					serverSide: true,
					"sServerMethod": "POST",
					"language": { "url": "/admin_assets/js/datatables/<?php echo e(app()->getLocale()); ?>.js" },
					"order": [[<?php echo e($sortValue ?? 1); ?>, '<?php echo e($sortOrder ?? "asc"); ?>']], // if sortable
					ajax: "<?php echo e(action($controller . '@dataTable')); ?>",
					stateSave: true,
	...
	<?php endif; ?>
<?php $__env->stopPush(); ?><?php /**PATH /home/ubuntu/theshit_php/Modules/PartnersQuests/Providers/../Resources/views/common/table/datatables.blade.php ENDPATH**/ ?>