                ...
                <div class="w-100">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Number-->
                                <span class="text-gray-800 fw-bold fs-4 me-3"><?php echo e(number_format(\Modules\Accounts\Entities\Account::select('id')->count())); ?></span>
                                <!--end::Number-->
                                <!--begin::Info-->
                                <!--begin::label-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                            ...
                            <div class="me-5">
                                ...
                                <!--begin::Desc-->
                                <!--end::Desc-->
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Active a hour: <?php echo e(number_format($lastHourPlaying)); ?> / a min: <?php echo e(number_format($lastMinutePlaying)); ?></span>
                                <!--end::Desc-->
                            </div>
                            <!--end::Content-->
                            <!--begin::Wrapper-->
                            <div class="d-flex align-items-center">
                                <!--begin::Number-->
                                <span class="text-gray-800 fw-bold fs-4 me-3"><?php echo e(number_format($nowPlaying)); ?></span>
                                <!--end::Number-->
                                <!--begin::Info-->
                                <!--begin::label-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Number-->
                                <span class="text-gray-800 fw-bold fs-4 me-3"><?php echo e(number_format($hasWallet)); ?></span>
                                <!--end::Number-->
                                <!--begin::Info-->
                                <!--begin::label-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Number-->
                                <span class="text-gray-800 fw-bold fs-4 me-3"><?php echo e(number_format($neverPlaying)); ?></span>
                                <!--end::Number-->
                                <!--begin::Info-->
                                <!--begin::label-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Number-->
                                <span class="text-gray-800 fw-bold fs-4 me-3"><?php echo e(number_format(\Modules\Accounts\Entities\Account::select('id')->where('parent_id', '>', 0)->count())); ?></span>
                                <!--end::Number-->
                                <!--begin::Info-->
                                <!--begin::label-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                            ...
                            <div class="me-5">
                                ...
                                <!--end::Title-->
                                <!--begin::Desc-->
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Waiting to play (notified: <?php echo e(number_format($callDownAccountsNotified)); ?> / processing: <?php echo e(number_format($callDowntNotifyJobs)); ?> / new: <?php echo e(number_format($callDownAccountsNotNotified)); ?>)</span>
                                <!--end::Desc-->
                            </div>
                            <!--end::Content-->
                            <!--begin::Wrapper-->
                            <div class="d-flex align-items-center">
                                <!--begin::Number-->
                                <span class="text-gray-800 fw-bold fs-4 me-3"><?php echo e(number_format($callDownAccounts)); ?></span>
                                <!--end::Number-->
                                <!--begin::Info-->
                                <!--begin::label-->
                    ...
                    t = function () {
                        ...
                        if (t) {
                            var a = t.hasAttribute("data-kt-negative-color") ? t.getAttribute("data-kt-negative-color") : KTUtil.getCssVariableValue("--bs-success"),
                                    ...
                                    i = {
                                        series: [
                                            { name: "Telegram", data: <?php echo e($telegram); ?> },
                                            { name: "WEB", data: <?php echo e($web); ?> },
                                        ],
                                        ...
                                        yaxis: {
                                            min: 0,
                                            max: <?php echo e($maxValueDays + 150); ?>,
                                            tickAmount: 6,
                                            labels: {
                    ...
                    t = function () {
                        ...
                        if (t) {
                            var a = t.hasAttribute("data-kt-negative-color") ? t.getAttribute("data-kt-negative-color") : KTUtil.getCssVariableValue("--bs-success"),
                                    ...
                                    i = {
                                        series: [
                                            { name: "Telegram", data: <?php echo e($gaming_telegram); ?> },
                                            { name: "WEB", data: <?php echo e($gaming_web); ?> },
                                        ],
                                        chart: { fontFamily: "inherit", type: "bar", stacked: !0, height: l, toolbar: { show: !1 } },
...
<?php $__env->stopPush(); ?><?php /**PATH /home/ubuntu/theshit_php/Modules/Core/Providers/../Resources/views/charts.blade.php ENDPATH**/ ?>