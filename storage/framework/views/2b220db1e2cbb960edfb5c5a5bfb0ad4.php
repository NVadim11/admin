...
<?php $__env->startSection('content'); ?>
		...
		<div class="card card-flush h-lg-100">
			...
			<div class="card-header pt-5">
				...
				<h3 class="card-title align-items-start flex-column">
					<span class="card-label fw-bold text-dark">Completing Daily Quests</span>
	...
	<div class="card rounded-0 border-0">
		...
		<div class="card-body pt-0">
			<?php echo $__env->make('daily_quests::common.table.' . $outlist, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		</div>
		<!--end::Card body-->
	</div>
	<!--end::Card-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('core::layouts.themes.' . config('assets.metronic.theme_path') . '.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/theshit_php/Modules/DailyQuests/Providers/../Resources/views/daily_quests/index.blade.php ENDPATH**/ ?>